    ...
    >
      ...
      <form onSubmit={handleSubmit(onPasswordLogin)} className="space-y-6">
        ...
        <button
          ...
          className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-md3-2 text-sm font-bold text-white bg-primary-600 hover:bg-primary-700 transition-colors disabled:opacity-70 cursor-pointer"
        >
              ...
              <form onSubmit={handleRequestForgotOtp} className="space-y-4">
                ...
                <div className="flex justify-end gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="px-5 py-2 text-xs font-bold text-white bg-primary-600 hover:bg-primary-700 rounded-xl shadow-sm transition-colors disabled:opacity-60"
                  >
