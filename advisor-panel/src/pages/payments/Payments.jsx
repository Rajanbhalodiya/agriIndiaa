...
export default function Payments() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Payments Overview</h1>
        <p className="mt-1 text-sm text-gray-500">
          Track revenue and payment status for all farmer orders.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 mb-1">Total Paid Volume</p>
